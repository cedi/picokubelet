...
impl Color {
    ...
    const RED: Self = Color { r: LED_BRIGHTNESS_CAP, g: 0, b: 0 };
    const GREEN: Self = Color { r: 0, g: LED_BRIGHTNESS_CAP, b: 0 };
    const BLUE: Self = Color { r: 0, g: 0, b: LED_BRIGHTNESS_CAP };
